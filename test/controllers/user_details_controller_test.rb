...
class UserDetailsControllerTest < ActionController::TestCase
  ...
  test "should create user_detail" do
    assert_difference('UserDetail.count') do
      post :create, user_detail: { address: @user_detail.address, case_id: @user_detail.case_id, date_of_birth: @user_detail.date_of_birth, name: @user_detail.name, party_type: @user_detail.party_type, phone: @user_detail.phone }
    end
  ...
  test "should update user_detail" do
    patch :update, id: @user_detail, user_detail: { address: @user_detail.address, case_id: @user_detail.case_id, date_of_birth: @user_detail.date_of_birth, name: @user_detail.name, party_type: @user_detail.party_type, phone: @user_detail.phone }
    assert_redirected_to user_detail_path(assigns(:user_detail))
  end
