...
class InterviewsControllerTest < ActionController::TestCase
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post :create, interview: { document: @interview.document, yn01: @interview.yn01, yn02: @interview.yn02, yn03: @interview.yn03, yn04: @interview.yn04, yn05: @interview.yn05, yn06: @interview.yn06 }
    end
  ...
  test "should update interview" do
    patch :update, id: @interview, interview: { document: @interview.document, yn01: @interview.yn01, yn02: @interview.yn02, yn03: @interview.yn03, yn04: @interview.yn04, yn05: @interview.yn05, yn06: @interview.yn06 }
    assert_redirected_to interview_path(assigns(:interview))
  end
